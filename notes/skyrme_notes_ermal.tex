...
\begin{equation}
 \begin{split}
  ...
  =&\frac{F_{1/2}(\eta_r)}{n_r}\Big[\delta_{ir}+\frac{3 n_r M_r^{*}}{\hbar^2}\big[\alpha_2+(\alpha_1-\alpha_2)\delta_{ir}\big]\Big]
 \end{split}
\end{equation}
Also, $\partial_{\eta}F_n(\eta)=nF_{n-1}(\eta) \leftrightarrow \partial_{u}F^{-1}_n(u)=(1/n)F_{n-1}(u)$:
\begin{equation}
 \begin{split}
  \partial_{n_i}\eta_r=&d_{u}F^{-1}_{1/2}(u_r) \times \partial_{n_i}u_r\\
  =&\frac{\partial{u}F_{1/2}(u_r)}{n_r \ F_{-1/2}(\eta_r)} \Big[\delta_{ir}+\frac{3 n_r M_r^{*}}{\hbar^2}\big[\alpha_2+(\alpha_1-\alpha_2)\delta_{ir}\big]\Big]\\
  =&\frac{2F_{1/2}(u_r)}{n_r \ F_{-1/2}(\eta_r)} \Big[\delta_{ir}+\frac{3 n_r M_r^{*}}{\hbar^2}\big[\alpha_2+(\alpha_1-\alpha_2)\delta_{ir}\big]\Big]\\
