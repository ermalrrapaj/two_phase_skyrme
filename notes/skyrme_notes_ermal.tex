...
\begin{equation}
 \begin{split}
  ...
  U_i=&\alpha_1 \tau_i+\alpha_2 \tau_{-i}+2A \rho + 4 B \rho_{-i}+\rho^{\delta} \big[C(1+\delta)\rho^2+4 D \rho_{-i}\big[\rho-(1-\delta)\rho_i\big] \big]
 \end{split}
\end{equation}
...
\begin{equation}
 \begin{split}
  \partial_{\rho_i}\eta_r=&d_{u}F^{-1}_{1/2}(u_r) \times \partial_{\rho_i}u_r\\
